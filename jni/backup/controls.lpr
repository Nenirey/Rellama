...
library controls;  //by Lamw: Lazarus Android Module Wizard: 7/5/2015 18:26:35]
...
{ Class:     com_example_appintentdemo3_Controls
  Method:    pAppOnCreate
...
begin
  Java_Event_pAppOnCreate(PEnv, this, context, layout, intent); Rellama.ReInit(
    gApp);
end;
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appintentdemo3/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_appintentdemo3_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appintentdemo3_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appintentdemo3_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appintentdemo3_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appintentdemo3_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_appintentdemo3_Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_appintentdemo3_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_appintentdemo3_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_appintentdemo3_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appintentdemo3_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appintentdemo3_Controls_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_com_example_appintentdemo3_Controls_'
    +'pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_com_example_appintentdemo3_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appintentdemo3_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appintentdemo3_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appintentdemo3_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appintentdemo3_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appintentdemo3_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appintentdemo3_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appintentdemo3_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_appintentdemo3_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_appintentdemo3_Controls_pOnTouch',
  pOnClickGeneric name 'Java_com_example_appintentdemo3_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appintentdemo3_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_com_example_appintentdemo3_Controls_pOnDown',
  pOnClick name 'Java_com_example_appintentdemo3_Controls_pOnClick',
  pOnLongClick name 'Java_com_example_appintentdemo3_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_com_example_appintentdemo3_Controls_pOnDoubleClick',
  pOnChange name 'Java_com_example_appintentdemo3_Controls_pOnChange',
  pOnChanged name 'Java_com_example_appintentdemo3_Controls_pOnChanged',
  pOnEnter name 'Java_com_example_appintentdemo3_Controls_pOnEnter',
  pOnBackPressed name 'Java_com_example_appintentdemo3_Controls_pOnBackPressed',
  pOnClose name 'Java_com_example_appintentdemo3_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_appintentdemo3_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appintentdemo3_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appintentdemo3_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appintentdemo3_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appintentdemo3_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appintentdemo3_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appintentdemo3_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_appintentdemo3_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_example_appintentdemo3_Controls'
    +'_pAppOnRequestPermissionResult',
  pOnContactManagerContactsExecuted name 'Java_com_example_appintentdemo3_'
    +'Controls_pOnContactManagerContactsExecuted',
  pOnContactManagerContactsProgress name 'Java_com_example_appintentdemo3_'
    +'Controls_pOnContactManagerContactsProgress',
  pOnSeekBarProgressChanged name 'Java_com_example_appintentdemo3_Controls_'
    +'pOnSeekBarProgressChanged',
  pOnSeekBarStartTrackingTouch name 'Java_com_example_appintentdemo3_Controls_'
    +'pOnSeekBarStartTrackingTouch',
  pOnSeekBarStopTrackingTouch name 'Java_com_example_appintentdemo3_Controls_'
    +'pOnSeekBarStopTrackingTouch',
  pOnSpinnerItemSelected name 'Java_com_example_appintentdemo3_Controls_'
    +'pOnSpinnerItemSelected',
  pOnTelephonyCallStateChanged name 'Java_com_example_appintentdemo3_Controls_'
    +'pOnTelephonyCallStateChanged',
  pOnTimer name 'Java_com_example_appintentdemo3_Controls_pOnTimer';
...
{AndroidWidget.pas}
  gApp.Title:= 'Rellama v1.0';
  gjAppName:= 'com.example.appintentdemo3';{AndroidWidget.pas}
  gjClassName:= 'com/example/appintentdemo3/Controls';{AndroidWidget.pas}
  gApp.AppName:=gjAppName;
  gApp.ClassName:=gjClassName;
  gApp.Initialize;
  gApp.CreateForm(TRellama, Rellama);
end.
(*last [smart] upgrade: 7/4/2016 0:39:56*)
